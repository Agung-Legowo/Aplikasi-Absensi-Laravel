                ...
                <div class="card2 card border-0 px-4 py-5">
                   ...
                   <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="row px-3"> <label class="mb-1">
                        ...
                        </label> <input class="mb-4" type="text" name="name" :value="old('name')"
                    ...
                    <div class="row px-3"> <label class="mb-1">
                        ...
                        </label> <input type="password" name="password_confirmation" placeholder="Enter confirm password"> </div>
                    <div class="row mb-3 px-3"> <button type="submit" class="btn btn-blue text-center">Register</button></div>
                     </from>
                    <div class="row mb-4 px-3"> <small class="font-weight-bold">AL Redy Register <a href="{{route('login') }}" 
