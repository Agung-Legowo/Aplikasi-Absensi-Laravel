     ...
     <!-- Page Heading -->
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            ...
                            <h6 class="m-0 font-weight-bold text-primary">Tambah letter</h6>
                        </div>
                        <div class="card-body">
                            <form class="form" method="post" action="{{route('letter.store')}}"enctype="multipart/form-data"> 
                                @csrf
                                <div class="form-group">
                                    <label class="label">Name letter</label>
                                    <input type="text" name="nameletter" placeholder="enter name letter" class="form-control">
                                </div>
                                ...
                                <div class="form-group">
                                    <label class="label">File Letter</label>
                                 ...
                                 <div class="form-group">
                                    ...
                                    <select name="category_id" class="form-control">
                                        ...
                                        <option value="{{ $categ->id }}"> {{$categ->namecategory}}</option>
                                        @endforeach
                                    </select>
                                 ...
                                 <div class="form-group">
                                    ...
                                    <textarea name="descriptionletter" class="form-control" rows="4">
                                    </textarea>
                                </div>
